    ...
    return (
        <div role="dialog" className="modal-mask" onClick={props.onCloseHandle}>
            ...
            <div className="modal-wrapper" style={{maxWidth: "490px"}}>
                <div className="modal-container" style={{overflowY: "auto"}} onClick={e => {e.stopPropagation()}}>
                    <div className="close-modal" onClick={props.onCloseHandle}>
                        ...
                        <div className="upload-modal-content">
                            <div className="canvas-cont">
                                <div  className="canvas-content">
                                    ...
                                    <p className="w-100 d-flex justify-content-center">Apasă iconița sau trage o imagine aici</p>
                                </div>
